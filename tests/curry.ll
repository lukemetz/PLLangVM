...
define void @main(%value* %env, %value %x){
    ...
    %2 =  call %value @test (%value* null, %value %1)
    %3 = call %value @wrap_i32(i32 2)
    %func_ptr_4 = call %value(%value*, %value)*(%value)* @extract_func(%value %2)
    %func_env_4 = call %value* @extract_env(%value %2)
    %4 =  call %value %func_ptr_4(%value * %func_env_4, %value %3)
    %5 = call %value @wrap_i32(i32 3)
    %func_ptr_6 = call %value(%value*, %value)*(%value)* @extract_func(%value %4)
    %func_env_6 = call %value* @extract_env(%value %4)
    %6 =  call %value %func_ptr_6(%value * %func_env_6, %value %5)
